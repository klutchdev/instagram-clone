...
export default function Photos({ photos }: PhotosProps) {
    return (
        <div className="h-16 pt-4 mt-12 border-t border-gray-primary">
                ...
                {!photos
                    ...
                    ? photos.map((photo) => (
                          <div key={photo.docId} className="relative group">
                              ...
                              <div className="absolute bottom-0 left-0 z-10 items-center hidden w-full h-full bg-gray-200 justify-evenly bg-black-faded group-hover:flex">
